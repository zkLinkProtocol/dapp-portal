...
import { EIP712_TX_TYPE, serialize } from "./utils";

import type { Provider } from "./provider";
import type { BlockTag, TransactionRequest, TransactionResponse } from "./types";
...
export class Wallet extends AdapterL2(AdapterL1(ethers.Wallet)) {
  ...
  static override async fromEncryptedJson(json: string, password?: string | ethers.Bytes, callback?: ProgressCallback) {
