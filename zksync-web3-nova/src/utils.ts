...
export const ZKSYNC_MAIN_ABI = new utils.Interface((await import('../abi/IZkSync.json')).abi);
...
export const IERC20 = new utils.Interface((await import('../abi/IERC20.json')).abi);
export const IERC1271 = new utils.Interface((await import('../abi/IERC1271.json')).abi);
export const L1_BRIDGE_ABI = new utils.Interface((await import('../abi/IL1Bridge.json')).abi);
export const L2_BRIDGE_ABI = new utils.Interface((await import('../abi/IL2Bridge.json')).abi);
